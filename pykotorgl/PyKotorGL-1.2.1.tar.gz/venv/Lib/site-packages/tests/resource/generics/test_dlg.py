...
class TestDLG(TestCase):
    ...
    def validate_io(self, dlg):
        ...
        self.assertEqual("abort", dlg.on_aborted)
        self.assertEqual("end", dlg.on_ended)
        ...
        self.assertEqual(1, entry0.script1_param1)
        self.assertEqual(2, entry0.script2_param1)
        self.assertEqual(3, entry0.script1_param2)
        self.assertEqual(4, entry0.script2_param2)
        self.assertEqual(5, entry0.script1_param3)
        self.assertEqual(6, entry0.script2_param3)
        self.assertEqual(7, entry0.script1_param4)
        self.assertEqual(8, entry0.script2_param4)
        self.assertEqual(9, entry0.script1_param5)
        self.assertEqual(11, entry0.script2_param5)
        self.assertEqual("aaa", entry0.script1_param6)
        self.assertEqual("bbb", entry0.script2_param6)
